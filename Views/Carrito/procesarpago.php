	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-30 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					<?php
						if(isset($_SESSION['login'])){
						?>
							<div>
								<label for="tipopago">Direccion de envio</label>
								<div class="bor8 bg0 m-b-12">
									<input id="txtDireccion" class = "stext-111 cl9 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Direccion de envio">
								</div>
								<div class="bor8 bg0 m-b-22">
									<input id="txtCiudad" class = "stext-111 cl9 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Ciudad / Estado">
							</div>
							...
							<form id="formRegister">
								<div class="row">
									...
									<div class="col col-md-6 form-group">
										...
										<input type="text" class="form-control valid validEmail" id="txtEmailCliente" name="txtEmailCliente"
										required ="">
									</div>
